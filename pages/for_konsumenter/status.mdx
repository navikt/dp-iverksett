...
Dersom dp-iverksett finner behandlingen, vil endepunktet svare med `200 OK` og utbetalingsstatus.

## Med Kafka

Vi har satt opp en topic hvor vi tilbyr statusendringer på utbetalinger: `teamdagpenger.iverksetting-status-v1`. Om dette
...
Dataklassen finner du i [`dp-kontrakter`](https://github.com/navikt/dp-kontrakter) om du ønsker å bruke den direkte.