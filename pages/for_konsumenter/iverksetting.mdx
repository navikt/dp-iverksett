...
# Endepunkter for iverksetting av utbetaling
...
_Eksempler_ (kan vi få dette i en sånn toggle-greie)
...
Listen av utbetalinger som dp-iverksett tar i mot skal være det gjeldende totalbildet av utbetalinger for saken. dp-iverksett håndterer utbetalingene
...
Under er et eksempel på hvordan dette totalbildet kan se ut for 10 meldekort som sendes inn og korrigeres:
![Totalbilde av utbetalinger eksempel](/totalbilde_utbetalinger.png)
...
sender den inn den nye sannheten for uke 1 og 2 _og_ uendret utbetaling for uke 3 og 4. Her er det to ting å merke seg:
...
Merk også at korrigeringen av utbetalingen for uke 5-6 (B-7) er et opphør. Ved opphør av utbetaling, forventer dp-iverksett at det ikke finnes noen utbetalinger
...
Dp-iverksett krever at konsumentene sender både vedtak om rett og utbetalingene som følger av meldekortene, med riktig kontekst. Tjenesten vil validere
...
som ikke har tilgang til å kalle med system-kontekst, vil utbetalingen avvises.
